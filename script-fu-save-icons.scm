...
(define (script-fu-save-icons-png image folder name interpolation x512 x256 x128 x64 x48 x38 x32 x22 x19 x16 interlace compression bKGD gAMA oFFs pHYs tIME comment svtrans)
...
(let* (
	...
	(y 0)
	(partName "")
	(formats (cons-array 10 'byte)) ; Modified by universeroc 2017.10.11 8=>10
	(formatsSelected (cons-array 10 'byte)) ; Modified by universeroc 2017.10.11 8=>10
	(fS 0)
)
...
(aset formats 3 64)
(aset formats 4 48)
(aset formats 5 38) ; Added by universeroc 2017.10.11
(aset formats 6 32)
(aset formats 7 22)
(aset formats 8 19) ; Added by universeroc 2017.10.11
(aset formats 9 16)
...
(aset formatsSelected 5 x38) ; Added by universeroc 2017.10.11
(aset formatsSelected 6 x32)
(aset formatsSelected 7 x22)
(aset formatsSelected 8 x19) ; Added by universeroc 2017.10.11
(aset formatsSelected 9 x16)


(while (< y 10) ; Modified by universeroc 2017.10.11 8=>10
...
(script-fu-register	"script-fu-save-icons-png"
					...
					SF-TOGGLE	"PNG 38 x 38px"		TRUE ; Added by universeroc 2017.10.11
					SF-TOGGLE	"PNG 32 x 32px"		TRUE
					SF-TOGGLE	"PNG 22 x 22px"		TRUE
					SF-TOGGLE	"PNG 19 x 19px"		TRUE ; Added by universeroc 2017.10.11
